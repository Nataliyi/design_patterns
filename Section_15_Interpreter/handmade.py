""""Интерпретатор. Данный Шаблон позволяет интерпретировать один язык в другой. 
В данном примере мы интерпретируем текст в типы python и выполняем запрос в тексте"""
