"""Шаблон Команда. Отлично подходит для систем, управляемых коммандами (событиями).
В данном примере записывается успешность выполнения той или иной команды для
безошибочного составления баланса"""
