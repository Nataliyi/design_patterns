"""Стратегия. Шаблон определяет семейство схожих алгоритмов и помещает каждый из них в собственный класс, 
после чего алгоритмы можно взаимозаменять прямо во время исполнения программы.
В данном примере отлично видно как, в зависимости от выбора формата, 
класс TexProcessor устанавливает класс - обработчик теста"""
