"""Наблюдатель. Шаблон позволяет оповещать другие объекты об изменении своего состояния.
В данном примере Пациент оповещает доктора, что он заболел и просит доктора приехать к нему."""
