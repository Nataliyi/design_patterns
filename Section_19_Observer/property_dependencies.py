"""Как создать "память" свойства, если у вас есть зависимости одно свойства от другого.
В данном примере свойство can_vote зависит от age."""
...
class Person(PropertyObservable):
  ...
  def age(self, value):
    if self._age == value:
      return
    # тут запишем в память предыдущий маркер о возможности голосовать
