"""Ручной способ создания телефонного робота-бота.
Создаем набор парметров и правил и запускаем опрос.
Как только выбор закончился и все действия выполнились - робот выключается."""
