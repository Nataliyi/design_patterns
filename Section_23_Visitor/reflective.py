"""Самое классное, что увидела в этом примере -- проверка isinstance! 
Отличный вариант проверки на соостветствие аргумента классу.
Также неклассический пример, не удовлетворена простотой использования и простотой архитектуры."""
