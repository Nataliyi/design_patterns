""" Файл не совпадает по курсу.. В файле определено намного больше, чем 
объяснено. Смысл заключается в пользе и эффективности наследования классов,
а так же грамотном переопределении атрибутов класса"""
